    ...
    <div className="left-2 absolute w-[70px] h-[71px] top-[17.5px]">
      ...
      >
        <path
          ...
          fill="url(#pattern-174:654-0)"
         />
        <defs>
          <pattern
            id="pattern-174:654-0"
            patternContentUnits="objectBoundingBox"
            width="1"
            height="1"
          >
            <use
              xlinkHref="#image0_174_654"
          ...
          <image
            ...
            width="1200"
            height="800"
            xlinkHref="https://uortjlczjmucmpaqqhqm.supabase.co/storage/v1/object/public/firejet-converted-images/images/dd09aacc-7677-411b-95c8-dcc80b03923d.webp"
           />
        </defs>
      </svg>
    </div>
