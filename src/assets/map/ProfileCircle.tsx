    ...
    <div className="left-2 absolute w-[70px] h-[71px] top-[17.5px]">
      ...
      >
        <path
          ...
          fill="url(#pattern-200:568-0)"
         />
        <defs>
          <pattern
            id="pattern-200:568-0"
            patternContentUnits="objectBoundingBox"
            width="1"
            height="1"
          >
            <use
              xlinkHref="#image0_200_568"
          ...
          <image
            ...
            width="1200"
            height="800"
            xlinkHref="https://uortjlczjmucmpaqqhqm.supabase.co/storage/v1/object/public/firejet-converted-images/images/256692e0-26cd-44b8-84ef-156076a743e6.webp"
           />
        </defs>
      </svg>
    </div>
